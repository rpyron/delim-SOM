#### Code to download/extract and process environmental data for Pyron et al 2024 test dataset
...
final_csv_file <- file.path(work_dir_main, "Aeneus_environmental.csv")


## Input dataset with Latitude and Longitude columns and ID as rownames
environmental_dataset <- Aeneus_spatial[, c("Latitude", "Longitude")]
...
## Download and process ClimateNAr data (https://climatena.ca/; scale-free; 2011-2020)
...
## Download and process Enhanced Vegetation Index (EVI) data (https://stac.openlandmap.org/evi_mod13q1.tmwm.inpaint/collection.json; 250m resolution; for 2020)
