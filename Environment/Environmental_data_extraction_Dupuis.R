#### Code to download/extract and process environmental data for Dupuis et al 2018 Polygonia test dataset
...
work_dir_main <- "Test data/Dupuis et al 2018"
final_csv_file <- file.path(work_dir_main, "Polygonia_environmental.csv")


## Input dataset with Latitude and Longitude columns and ID as rownames
environmental_dataset <- Polygonia_spatial
